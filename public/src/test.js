const accounts = [
  ...
  function findAccountById(accounts, idInput) {
    let output = accounts.filter(account => account.id === idInput)
    return output[0];
  }
 ...
 //console.log(getTotalNumberOfBorrows(accounts[1], books))
 ...
 function partitionBooksByBorrowedStatus(books) {
    ...
    let checkedOutBooks = books.filter(book => book.borrows.filter(bookId => bookId.returned))
    ...
    let output = checkedOutBooks.length
    return output
 }
